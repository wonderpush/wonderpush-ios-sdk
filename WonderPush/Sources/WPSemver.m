...
- (NSComparisonResult)compare:(WPSemver *)aVersion
{
...
- (BOOL)isEqualTo:(id)aVersion
{
    ...
    return [self compare:(WPSemver * _Nonnull)aVersion] == NSOrderedSame;
}

- (BOOL)isLessThan:(id)aVersion
{
    if(![aVersion isKindOfClass:[self class]]) return NO;
    return [self compare:(WPSemver * _Nonnull)aVersion] == NSOrderedAscending;
}

- (BOOL)isGreaterThan:(id)aVersion
{
    if(![aVersion isKindOfClass:[self class]]) return NO;
    return [self compare:(WPSemver * _Nonnull)aVersion] == NSOrderedDescending;
}
