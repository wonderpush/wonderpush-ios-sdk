...
#define DEFAULT_MAXIMUM_COLLAPSED_LAST_CUSTOM_TRACKED_EVENTS_COUNT 100
#define DEFAULT_MAXIMUM_COLLAPSED_OTHER_TRACKED_EVENTS_COUNT 100
#define DEFAULT_MAXIMUM_UNCOLLAPSED_TRACKED_EVENTS_COUNT 1000
