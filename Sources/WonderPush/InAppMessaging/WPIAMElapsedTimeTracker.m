...
#import "WPIAMElapsedTimeTracker.h"
@interface WPIAMElapsedTimeTracker ()
@property(nonatomic) NSTimeInterval totalTrackedTimeSoFar;
@property(nonatomic) NSTimeInterval lastTrackingStartPoint;
@property(nonatomic, nonnull) id<WPIAMTimeFetcher> timeFetcher;
@property(nonatomic) BOOL tracking;
@end

@implementation WPIAMElapsedTimeTracker
