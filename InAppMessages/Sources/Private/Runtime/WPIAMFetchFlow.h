...
typedef void (^WPIAMFetchMessageCompletionHandler)(
    NSArray<WPIAMMessageDefinition *> *_Nullable messages,
    NSNumber *_Nullable nextFetchWaitTime,
    NSInteger discardedMessageCount,
    NSError *_Nullable error);

@protocol WPIAMMessageFetcher
...
@interface WPIAMFetchFlow : NSObject
