...
@implementation WPIAMModalViewController
...
- (IBAction)actionButtonTapped:(id)sender {
    [self followAction:self.modalDisplayMessage.action];
}
...
- (struct TitleBodyButtonHeightInfo)estimateTextBtnColumnHeightWithDisplayWidth:(CGFloat)displayWidth
